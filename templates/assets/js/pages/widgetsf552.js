			...
			!(function () {
				...
				(function () {
					...
					if (t) {
						var e = {
							series: [
								{ name: "Net Profit", data: [20, 30, 45, 35, 25] },
								{ name: "Revenue", data: [-20, -30, -45, -35, -25] },
							],
							chart: {
								type: "bar",
								stacked: !0,
				...
				(function () {
					...
					if (t) {
						var o = KTUtil.changeColor(
							...
							a = {
								series: [
									{ name: "Net Profit", data: [10, 10, 20, 20, 12, 12] },
								],
								chart: {
									type: "area",
									height: e,
				...
				KTUtil.getById("kt_forms_widget_2_form") &&
					new Quill("#kt_forms_widget_2_editor", {
						modules: {
							toolbar: { container: "#kt_forms_widget_2_editor_toolbar" },
						},
